    ...
    <div className='w-[99vw] md:w-[100vw] min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
      ...
      <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
        <div className='lg:w-[50%] w-[100%] flex items-center justify-center'>
          <img src={background3} alt="Contact Page Image" className='lg:w-[70%] w-[80%] shadow-md shadow-black rounded-sm' />
        </div>
        ...
        <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]'>
          ...
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
            ...
            <p>Random City, State, Nepal</p>
          </p>

          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
            <p>tel: +977-9876543210</p>
            <p>Email: admin@macart.com</p>
          </p>
          ...
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
            Learn more about oour teams and job openings
          </p>
