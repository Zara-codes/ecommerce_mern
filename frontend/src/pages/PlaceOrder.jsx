...
const PlaceOrder = () => {
  ...
  const { cartItem, setCartItem, getCartAmount, getSingleCartAmount, delivery_fee, products } = useContext(shopDataContext)
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      let orderData = {
        address: formData,
        items: orderItems,
        amount: getSingleCartAmount(productId, size) + delivery_fee
      }
        ...
        case 'esewa':
          ...
          if (productId && size) {
            ...
            if (itemInfo) {
              itemInfo.size = size
              itemInfo.quantity = quantity
              orderItemsForEsewa.push(itemInfo)
              navigate('/placeorderbyesewa', { state: { productId, size } })
    ...
    <div className='w-[100vw] min-h-[100vh] relative bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center flex-col md:flex-row gap-[50px]'>
      ...
      <div className='lg:w-[50%] w-[100%] min-h-[100%] flex items-center justify-center gap-[30px]'>
        <div className='lg:w-[70%] w-[90%] lg:h-[70%] h-[100%] flex items-center justify-center gap-[10px] flex-col'>
          <CartTotal itemId={productId} size={size} />
          <div className='py-[10px]'>
